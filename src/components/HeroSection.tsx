...
//               {/* Left Column - Content (Takes more space on desktop) */}
//               <div className="lg:col-span-7 xl:col-span-8 space-y-6 md:space-y-8">
                
//                 {/* Main Title */}
//                 <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold animate-slide-up leading-tight" style={{ animationDelay: '0.1s' }}>
...
//                   <blockquote className="text-l md:text-xl lg:text-2xl font-medium text-foreground leading-relaxed">
...
//               {/* Right Column - Profile Image (Proper spacing on desktop) */}
//               <div className="lg:col-span-5 xl:col-span-4 flex justify-center lg:justify-end animate-slide-up" style={{ animationDelay: '0.3s' }}>
//                 <div className="relative">
//                   {/* Profile Image with proper sizing */}
//                   <div className="w-64 h-64 md:w-80 md:h-80 lg:w-72 lg:h-72 xl:w-90 xl:h-90 rounded-full bg-gradient-primary p-2 shadow-xl">
...
//                   <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-neon-purple rounded-full animate-pulse" style={{ animationDelay: '0.5s' }} />
//                 </div>
//               </div>
//             </div>
//           </div>
    ...
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container relative z-10 animate-fade-in">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12 items-center min-h-screen">
            
            {/* Left Column - Content */}
            <div className="text-left space-y-3 sm:space-y-4 md:space-y-6 lg:space-y-8">
              {/* Main Title */}
              ...
              {/* CTA Buttons */}
              <div className="flex flex-col gap-2 sm:gap-3 md:gap-4 animate-slide-up" style={{ animationDelay: '0.6s' }}>
                <Button
              ...
              {/* Social Links */}
              <div className="flex space-x-2 sm:space-x-3 md:space-x-4 lg:space-x-6 animate-slide-up" style={{ animationDelay: '0.8s' }}>
                <a
                  href="https://github.com/beinghadibadami"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="flex justify-center animate-slide-up" style={{ animationDelay: '0.3s' }}>
              <div className="relative">
                ...
                <div className="w-24 h-24 sm:w-32 sm:h-32 md:w-48 md:h-48 lg:w-64 lg:h-64 xl:w-80 xl:h-80 rounded-full bg-gradient-primary p-1 sm:p-1.5 md:p-2 shadow-2xl">
                  <div className="w-full h-full rounded-full bg-background-secondary flex items-center justify-center overflow-hidden">
                    <img
                      src="/lift.jpg"
                      alt="Hadi Badami"
